# http://stefan.haflidason.com/simpler-handling-of-ajax-form-errors-in-rails-4/
$.fn.render_form_errors = (model_name, errors) ->
  ...
  $.each(errors, (field, messages) ->
    ...
    if input.parent().hasClass('input-group')
      input.parent().parent().append('<span class="help-block">' + $.map(messages, (m) -> m.charAt(0).toUpperCase() + m.slice(1)).join('<br />') + '</span>')
    else
